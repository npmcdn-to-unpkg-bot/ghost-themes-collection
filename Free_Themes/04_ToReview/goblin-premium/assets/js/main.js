        ...
        if($newElements.length && ( $('body').is('.post-template') ||
            ...
            jQuery.each($newElements,function( i, val ){
                        ...
                        if(videoUrl!=''){
                            ...
                            if(sfApp.isMobile()){
                                ...
                                if(youtubeId!=''){
                                    ...
                                    $line.html('<a class="video-playback youtube" href="'+videoUrl+'" data-toggle="tooltip" data-placement="right" title="See full size image!"></a>');
                                ...
                                $line.html('<a class="video-playback youtube" href="javascript:;" data-toggle="tooltip" data-placement="right" title="See full size image!"></a>');
                                $('.video-playback',$line).tooltip();
                            }
                        }
                    }
                ...
                // Video Post By iframe
                    ...
                    if(regResult[3] != undefined && regResult[3]!=''){
                        ...
                        if(sfApp.isMobile()){
                            ...
                            $line.html('<a class="video-playback youtube" href="http://www.youtube.com/watch?v='+videoUrl+'" data-toggle="tooltip" data-placement="right" title="See full size image!"></a>');
                            $('.video-playback',$line).tooltip();
                            var $videoPlayback=$line.find('.video-playback');
                            $videoPlayback.magnificPopup({
                                type: 'iframe',
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                if(result.length){
                                    ...
                                    var $line = $postHeader.find('.line');
                                    $line.html('<a class="video-playback vimeo" href="'+vimeoVideoUrl+'" data-toggle="tooltip" data-placement="right" title="See full size image!"></a>');
                                    $('.video-playback',$line).tooltip();
                                    var $videoPlayback=$line.find('.video-playback');
                                    $videoPlayback.magnificPopup({
                                        type: 'iframe',
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                if(result.length){
                                    ...
                                    $postHeader.css('background-image', 'url("'+result[0].thumbnail_large+'")');
                                    var $line = $postHeader.find('.line');
                                    $line.html('<a class="video-playback vimeo" href="https://vimeo.com/'+vimeoId+'" data-toggle="tooltip" data-placement="right" title="See full size image!"></a>');
                                    $('.video-playback',$line).tooltip();
                                    var $videoPlayback=$line.find('.video-playback');
                                    $videoPlayback.magnificPopup({
                                        type: 'iframe',
                ...
                // Audio Post By Link
                    ...
                    var $line = $postHeader.find('.line');
                    $line.html('<a class="audio-playback" href="javascript:;" data-toggle="tooltip" data-placement="right" title="See full size image!"></a>');
            ...
            $('.post').imagesLoaded(function(){
                $('.post:not(.formated)').each(function() {
                    ...
                    // Audio Post By iframe
                        ...
                        $line.html('<a class="image-popup" href="'+bg_url+'" data-toggle="tooltip" data-placement="right" title="See full size image!"></a>');
                        $line.addClass('has-icon');
                    ...
                    // Image Post
                        ...
                        $postHeader.css('background-image', 'url("'+$backgroundEl.attr('src')+'")');
                        $line.html('<a class="image-popup" href="'+$backgroundEl.attr('src')+'" data-toggle="tooltip" data-placement="right" title="See full size image!"></a>');
                        $line.addClass('has-icon');
                        $line.find('.image-popup').tooltip();
                        $line.find('.image-popup').magnificPopup({
                            type: 'image',
