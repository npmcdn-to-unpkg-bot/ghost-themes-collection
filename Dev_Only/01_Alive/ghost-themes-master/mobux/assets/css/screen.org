...
html {
  font: 85%/1.65 "Open Sans",sans-serif;
}
body { margin: 0; }
...
code, kbd, pre,
/*samp { font-family: monospace, serif; font-size: 1em; }a*/
...
@font-face {
    font-family: "mobux-icons";
    src:url("../fonts/mobux/mobux-icons.eot?v=1");
    src:url("../fonts/mobux/mobux-icons.eot?v=1#iefix") format("embedded-opentype"),
        url("../fonts/mobux/mobux-icons.woff?v=1") format("woff"),
        url("../fonts/mobux/mobux-icons.ttf?v=1") format("truetype"),
        url("../fonts/mobux/mobux-icons.svg?v=1#icons") format("svg");
    font-weight: normal;
    font-style: normal;
}
...
[class^="icon-"]:before, [class*=" icon-"]:before {
    font-family: "mobux-icons", "Open Sans", sans-serif;
    speak: none;
    font-style: normal;
    font-weight: normal;
    font-variant: normal;
